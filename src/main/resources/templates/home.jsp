...
<head>
    ...
    <style>
        ...
        #sidebar {
            ...
            height: 100%;
            overflow-y: auto;
            border-right: 2px solid #fff; /* Add an outline */
        }

        #content {
            margin-left: 320px; /* Adjusted to match the sidebar width */
            padding: 20px;
        }

        /* Header Styles */
        #header {
            background: url('backhead.jpg') center/cover no-repeat; /* Set the background image in the header */
             color: #00008B;
            padding: 10px;
            text-align: center;
        ...
        .post-actions {
            ...
            padding: 15px 0; /* Increased space between icons */
        }
        ...
        #sidebar a {
            ...
            color: #fff;
            display: block;
            padding: 15px 0; /* Increased space around icons */
            border-radius: 5px;
